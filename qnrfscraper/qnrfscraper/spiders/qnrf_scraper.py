...
labels = ['Proposal Number:', 'Program Cycle:', 'Submitting Institution Name:', 'Project Status:', 'Start Date:', 'Lead Investigator:', 'Project Duration:', 'End Date:', 'SubmissionType:', 'Proposal Title:', 'Proposal Description:', 'Benefit to Qatar:', 'Research Area Keywords:', 'Research Area Keywords by PM:', 'Research Type:', 'Research Area', 'Sub Research Area', 'Sub Speciality', 'Primary?', 'Secondary?', 'Institution', 'Country', 'Institution Role', 'Role', 'Name', 'Affiliation', 'Type', 'Publication Title', 'Authors', 'Reference No']
...
class qnrf_scraper(scrapy.Spider):
    ...
    # unused_labels = ['Benefit to Qatar:','Research Area Keywords by PM:','Research Area', 'Sub Research Area', 'Sub Speciality', 'Primary?', 'Secondary?', 'Institution', 'Country', 'Institution Role', 'Role', 'Name', 'Affiliation', 'Type', 'Publication Title', 'Authors', 'Reference No']
    ...
    def parse_research_page(self, response):
        ...
        # print(response.xpath('//div[contains(@class, "panel") and contains(@class ,"panel-default")]//div[contains(@class, "panel-title") and contains (text(),"Institution")]//following::div[contains(@class, "form-group")]/text()[normalize-space()]').extract())
        # print(response.xpath('//div[contains(@class, "panel-title") and contains (text(),"Institution")]//following::div[contains(@class, "form-group")]/text()[normalize-space()]').extract())
